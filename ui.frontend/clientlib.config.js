...
const getEntrypoints = require('./build-utils/entrypoints')
   ...
   libs: [
      {
         ...
         categories: ['vite.dependencies', 'vite.site.icons'],
         assets: {
      ...
      {
         ...libsBaseConfig,
         name: 'clientlib-site-core',
         categories: ['vite.site.core'],
         dependencies: ['vite.dependencies'],
         assets: {
            // Copy entrypoint scripts and stylesheets into the respective ClientLib
            // directories
            js: {
               cwd: 'clientlib-site-core',
               files: ['**/*.js'],
               flatten: false,
            },
            css: {
      ...
      {
         ...libsBaseConfig,
         name: 'clientlib-site-react',
         categories: ['vite.site.react'],
         assets: {
            // Copy entrypoint scripts and stylesheets into the respective ClientLib
