...
const _rootShadows = /* @__PURE__ */ new WeakMap();
const _models = /* @__PURE__ */ new WeakMap();
...
function renderCustomElement(component) {
  ...
  const root = clientExports.createRoot(_rootShadows.get(component));
...
CustomElement.ReactComponent = void 0;
CustomElement.domModel = void 0;
CustomElement.renderRoot = void 0;
function createCustomElement(ReactComponent, Model, renderRoot = "element") {
  class CustomCustomElement extends CustomElement {
  }
  CustomCustomElement.observedAttributes = void 0;
...
class DOMModel {
  constructor() {
    ...
    this._attributeKeys = void 0;
    this._observers = void 0;
    this._events = void 0;
    this._exportableProperties = void 0;
  ...
  return function(target, key, descriptor) {
    ...
    if (target.addProperty) {
      target.addProperty(key, (element) => {
        return element && (element.hasAttribute(attributeName) ? element.getAttribute(attributeName) : defaultValue);
      });
    }
  };
});
...
let DummyCompModel = (_dec = byAttrVal(), _class = class DummyCompModel2 extends DOMModel {
  constructor(...args) {
    super(...args);
...
const DummyComp = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dummy-comp-wrapper", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Final Library is working! Huzzah! Hunzah!" })
  ] });
};
const DummyCompElement = createCustomElement(DummyComp, DummyCompModel, "element");
